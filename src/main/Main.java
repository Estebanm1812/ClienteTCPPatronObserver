...
public class Main implements OnAnswerListener, OnConnectionListener, OnRTTListener, OnRTTReceiberListener,OnBWListener{
	...
	public void executeOperation(int option){
		...
		connection.setAnswer(this);
		connection.setConnection(this);
		connection.setNotification(this);
		connection.setRttReciber(this);
		connection.setBwListener(this);
